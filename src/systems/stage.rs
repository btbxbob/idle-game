...
pub fn required_technology_for_building(building_name: &str) -> Option<TechnologyId> {
    match building_name {
        ...
        "电路板厂" | "芯片制造厂" => Some(TechnologyId::Electronics),
        "量子计算中心" => Some(TechnologyId::QuantumComputing),
        "发电机厂" => Some(TechnologyId::RenewableEnergy),
        "机器人工厂" => Some(TechnologyId::Robotics),
