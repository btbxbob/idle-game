    ...
    constructor() {
        ...
        this.translations = {
            'en': {
                ...
                'workersShown': 'Shown',
                'workersPrevPage': 'Prev Page',
                'workersNextPage': 'Next Page',
                'workersPageStatus': 'Page {current} / {total}',
                ...
                'eventLogSubtitle': 'Track the reports, incidents, and mutations currently reshaping the settlement.',
                ...
                'eventOutcome_foodLoss': 'Food -{amount}',
                'eventOutcome_corpseGain': 'Corpses +{amount}',
            ...
            'zh-CN': {
                ...
                'workersPrevPage': '上一页',
                'workersNextPage': '下一页',
                'workersPageStatus': '第 {current} / {total} 页',
                'assignedWorkers': '已分配',
                'noWorkers': '没有工人',
                ...
                'eventLogTitle': '聚落新闻流',
                'eventLogSubtitle': '追踪聚落里正在改写秩序的新闻、事故与异变。',
                ...
                'eventOutcome_foodLoss': '食物 -{amount}',
                'eventOutcome_corpseGain': '尸体 +{amount}',
