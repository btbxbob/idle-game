...
test.describe('Crafting System', () => {
    ...
    test('coins to wood conversion (100:10 ratio)', async ({ page }) => {
        ...
        if (coinsValue >= 100) {
            ...
            const craftButton = coinsToWoodRecipe.locator('.craft-button, button');
    ...
    test('coins to stone conversion (100:1 ratio)', async ({ page }) => {
        ...
        if (coinsValue >= 100) {
            ...
            const craftButton = coinsToStoneRecipe.locator('.craft-button, button');
    ...
    test('wood to coins conversion (10:100 ratio)', async ({ page }) => {
        ...
        if (woodValue >= 10) {
            ...
            const craftButton = woodToCoinsRecipe.locator('.craft-button, button');
    ...
    test('crafting failure feedback displays', async ({ page }) => {
        ...
        if (isDisabled) {
            // Disabled button itself is acceptable failure feedback in current UI.
            console.log('Button was disabled, no explicit failure toast expected');
